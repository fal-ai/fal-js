...
export const H31TextTo3dInputSchema = {
  properties: {
    negative_prompt: {
      ...
      anyOf: [{ maxLength: 1024, type: "string" }, { type: "null" }],
...
export const Hunyuan3dV31ProImageTo3dInputSchema = {
  ...
  properties: {
    back_image_url: {
      anyOf: [
        { type: "string", _fal_ui_field: "image", ui: { field: "image" } },
        { type: "null" },
      ],
...
export const Hunyuan3dV3ImageTo3dInputSchema = {
  ...
  properties: {
    ...
    right_image_url: {
      ...
      title: "Right Image Url",
      anyOf: [
        { ui: { field: "image" }, type: "string", _fal_ui_field: "image" },
        { type: "null" },
      ],
      description:
...
export const Sam33dObjectsInputSchema = {
  ...
  properties: {
    ...
    detection_threshold: {
      anyOf: [{ type: "number", minimum: 0.1, maximum: 1 }, { type: "null" }],
      description:
