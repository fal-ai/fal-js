...
export const Deepfilternet3OutputSchema = {
  properties: {
    timings: {
      ...
      $ref: "#/components/schemas/DeepFilterNetTimings",
    },
    audio_file: {
...
export const ElevenlabsMusicInputSchema = {
  properties: {
    composition_plan: {
      anyOf: [
        {
          $ref: "#/components/schemas/MusicCompositionPlan",
        },
        {
          type: "null",
        },
...
export const F5TtsOutputSchema = {
  ...
  properties: {
    audio_url: {
      ...
      $ref: "#/components/schemas/AudioFileType3",
...
export const LavaSrOutputSchema = {
  properties: {
    ...
    timings: {
      $ref: "#/components/schemas/LavaSRTimings",
      description: "Timings for each step in the pipeline.",
    },
  },
  title: "LavaSROutput",
...
export const MinimaxMusicV25InputSchema = {
  ...
  properties: {
    ...
    audio_setting: {
      description: "Audio configuration settings",
      $ref: "#/components/schemas/AudioSetting25",
    },
  },
} as const;
...
export const MusicCompositionPlanSchema = {
  properties: {
    ...
    sections: {
      items: {
        $ref: "#/components/schemas/MusicSection",
      },
      title: "Sections",
      type: "array",
...
export const NovaSrOutputSchema = {
  ...
  properties: {
    ...
    timings: {
      description: "Timings for each step in the pipeline.",
      $ref: "#/components/schemas/NovaSRTimings",
    },
  },
} as const;
...
export const SamAudioSpanSeparateInputSchema = {
  ...
  properties: {
    ...
    spans: {
      items: {
        $ref: "#/components/schemas/AudioTimeSpan",
      },
      examples: [
        [
          {
...
export const WorkflowUtilitiesAudioCompressorOutputSchema = {
  ...
  properties: {
    audio: {
      ...
      $ref: "#/components/schemas/AudioFileType2",
    },
  },
} as const;
