...
import type {
  ...
  Trellis2Input,
  Trellis2Output,
  Trellis2RetextureInput,
  Trellis2RetextureOutput,
  TrellisInput,
  TrellisMultiInput,
  TrellisMultiOutput,
  TrellisOutput,
...
export type Gen3dEndpointMap = {
  ...
  "fal-ai/reconviagen-0.5": {
    input: Reconviagen05Input;
    output: Reconviagen05Output;
  };
  ...
  "fal-ai/trellis-2/retexture": {
    input: Trellis2RetextureInput;
    output: Trellis2RetextureOutput;
  };
