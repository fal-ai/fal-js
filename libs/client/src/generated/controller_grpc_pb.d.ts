...
interface IIsolateControllerService_IRun
...
interface IIsolateControllerService_IMap
  extends grpc.MethodDefinition<
...
interface IIsolateControllerService_ISchedule
  extends grpc.MethodDefinition<
...
interface IIsolateControllerService_IListScheduledRuns
  extends grpc.MethodDefinition<
...
interface IIsolateControllerService_ICancelScheduledRun
  extends grpc.MethodDefinition<
...
interface IIsolateControllerService_IListScheduledRunActivations
  extends grpc.MethodDefinition<
...
interface IIsolateControllerService_IGetScheduledActivationLogs
  extends grpc.MethodDefinition<
...
interface IIsolateControllerService_ICreateUserKey
  extends grpc.MethodDefinition<
...
interface IIsolateControllerService_IListUserKeys
  extends grpc.MethodDefinition<
...
interface IIsolateControllerService_IRevokeUserKey
  extends grpc.MethodDefinition<
...
export interface IIsolateControllerServer
  extends grpc.UntypedServiceImplementation {
  run: grpc.handleServerStreamingCall<
    controller_pb.HostedRun,
    controller_pb.HostedRunResult
  >;
  map: grpc.handleServerStreamingCall<
    controller_pb.HostedMap,
    controller_pb.HostedRunResult
  >;
  schedule: grpc.handleUnaryCall<
    ...
    controller_pb.ScheduleInfo
  >;
  listScheduledRuns: grpc.handleUnaryCall<
    controller_pb.ListScheduledRunsRequest,
    controller_pb.ListScheduledRunsResponse
  >;
  cancelScheduledRun: grpc.handleUnaryCall<
    controller_pb.CancelScheduledRunRequest,
    controller_pb.CancelScheduledRunResponse
  >;
  listScheduledRunActivations: grpc.handleUnaryCall<
    controller_pb.ListScheduledRunActivationsRequest,
    controller_pb.ListScheduledRunActivationsResponse
  >;
  getScheduledActivationLogs: grpc.handleUnaryCall<
    controller_pb.GetScheduledActivationLogsRequest,
    controller_pb.GetScheduledActivationLogsResponse
  >;
  createUserKey: grpc.handleUnaryCall<
    controller_pb.CreateUserKeyRequest,
    controller_pb.CreateUserKeyResponse
  >;
  listUserKeys: grpc.handleUnaryCall<
    controller_pb.ListUserKeysRequest,
    controller_pb.ListUserKeysResponse
  >;
  revokeUserKey: grpc.handleUnaryCall<
    controller_pb.RevokeUserKeyRequest,
    controller_pb.RevokeUserKeyResponse
  >;
}
...
export interface IIsolateControllerClient {
  run(
    request: controller_pb.HostedRun,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<controller_pb.HostedRunResult>;
  run(
    request: controller_pb.HostedRun,
  ...
  map(
    request: controller_pb.HostedMap,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<controller_pb.HostedRunResult>;
  map(
    request: controller_pb.HostedMap,
  ...
  schedule(
    request: controller_pb.HostedRunCron,
    callback: (
      error: grpc.ServiceError | null,
      response: controller_pb.ScheduleInfo
    ) => void
  ...
  listScheduledRuns(
    request: controller_pb.ListScheduledRunsRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: controller_pb.ListScheduledRunsResponse
    ) => void
  ): grpc.ClientUnaryCall;
  listScheduledRuns(
    request: controller_pb.ListScheduledRunsRequest,
  ...
  cancelScheduledRun(
    request: controller_pb.CancelScheduledRunRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: controller_pb.CancelScheduledRunResponse
    ) => void
  ): grpc.ClientUnaryCall;
  cancelScheduledRun(
    request: controller_pb.CancelScheduledRunRequest,
  ...
  listScheduledRunActivations(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: controller_pb.ListScheduledRunActivationsResponse
    ) => void
  ): grpc.ClientUnaryCall;
  listScheduledRunActivations(
    request: controller_pb.ListScheduledRunActivationsRequest,
  ...
  getScheduledActivationLogs(
    request: controller_pb.GetScheduledActivationLogsRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: controller_pb.GetScheduledActivationLogsResponse
    ) => void
  ): grpc.ClientUnaryCall;
  getScheduledActivationLogs(
    request: controller_pb.GetScheduledActivationLogsRequest,
  ...
  createUserKey(
    request: controller_pb.CreateUserKeyRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: controller_pb.CreateUserKeyResponse
    ) => void
  ): grpc.ClientUnaryCall;
  createUserKey(
    request: controller_pb.CreateUserKeyRequest,
  ...
  listUserKeys(
    request: controller_pb.ListUserKeysRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: controller_pb.ListUserKeysResponse
    ) => void
  ): grpc.ClientUnaryCall;
  listUserKeys(
    request: controller_pb.ListUserKeysRequest,
  ...
  revokeUserKey(
    request: controller_pb.RevokeUserKeyRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: controller_pb.RevokeUserKeyResponse
    ) => void
  ): grpc.ClientUnaryCall;
  revokeUserKey(
    request: controller_pb.RevokeUserKeyRequest,
...
export class IsolateControllerClient
  extends grpc.Client
  implements IIsolateControllerClient
{
  constructor(
    address: string,
  ...
  public listScheduledRunActivations(
    request: controller_pb.ListScheduledRunActivationsRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: controller_pb.ListScheduledRunActivationsResponse
  ...
  public getScheduledActivationLogs(
    request: controller_pb.GetScheduledActivationLogsRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: controller_pb.GetScheduledActivationLogsResponse
