...
proto.BoundFunction = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.BoundFunction.repeatedFields_,
    null
  );
};
    ...
    var f,
      obj = {
        environmentsList: jspb.Message.toObjectList(
          ...
          proto.EnvironmentDefinition.toObject,
          includeInstance
        ),
        pb_function:
          (f = msg.getFunction()) &&
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.EnvironmentDefinition.deserializeBinaryFromReader
        );
 ...
 */
proto.BoundFunction.prototype.addEnvironments = function (
  opt_value,
  opt_index
) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.EnvironmentDefinition.prototype.toObject = function (
    opt_includeInstance
  ) {
 ...
 * @return {!proto.EnvironmentDefinition}
 */
proto.EnvironmentDefinition.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.EnvironmentDefinition.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
